...
for (var i = 0; i < link_list.length; i++) {
    ...
    imag.alt = "Máquina Mortífera (Duplado) - Episódio " + (currentEpisodioNum) + " - T" + currentTempNum;
    imag.title = "Máquina Mortífera (Duplado)- Episódio " + (currentEpisodioNum) + " - T" + currentTempNum;
