...
for (var i = 0; i < link_list.length; i++) {
    ...
    imag.alt = "Chicago Fire (Duplado) - Episódio " + (currentEpisodioNum) + " - T" + currentTempNum;
    imag.title = "Chicago Fire (Duplado)- Episódio " + (currentEpisodioNum) + " - T" + currentTempNum;
